...
func TestKey_Sign(t *testing.T) {
	...
	tests := []struct {
		...
		{"basic",
			fields{"npvta8jaftcjebc56pvxgs8w2448fibvc4yqeub8b49b7k4tdg7t5dsdhayzi569eaaaaaaaaaaaadmt69zefwr5pfdk99mg23ufiu58nazicguu9g6r58xeqwguxxachhw8sfiuejtf"},
			args{"AQIDBA=="},
			&Signature{"uibnit3siwbccafzk58sizh53uqjys5bryccmrwqgd5eekjd52peupy44smqgrye46bcab3jijwbraeunmhe6g48kj5c9mwr88bq97jc2d4m2xsvj6pzqhfs"},
			false},
		...
		{"different key should gen diff sig",
			...
			args{"AQIDBA=="},
			&Signature{"uibnittsisbcaieksj9fb7ig5w4asg4mrinnqn8yx9c6p2xwxaa9xkbindaqm75raisdg8v3i4u64brxqx95q3xd7qgtqvxr6utpqcy6zv4ktjvy3k5k5ia="},
			false},
